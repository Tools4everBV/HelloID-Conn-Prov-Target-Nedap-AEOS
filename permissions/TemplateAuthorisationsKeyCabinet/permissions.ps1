############################################################
# HelloID-Conn-Prov-Target-Nedap-AEOS-Permissions-TemplateAuthorisationKeyCabinet
# PowerShell V2
############################################################
...
try {
    ...
    # SOAP body to search for KeyCabinet authorization templates
    [xml]$body = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:sch="http://www.nedap.com/aeosws/schema">
        ...
        <soapenv:Body>
            <sch:TemplateSearchInfo>
                <sch:TemplateInfo>
                    <sch:UnitOfAuthType>KeyCabinet</sch:UnitOfAuthType>
                </sch:TemplateInfo>
            </sch:TemplateSearchInfo>
        </soapenv:Body>
        </soapenv:Envelope>'
